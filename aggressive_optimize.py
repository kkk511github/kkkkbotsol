...
def aggressive_optimization():
    ...
    test_configs = [
        ...
        # 配置2: 更高仓位 + 更低阈值
        (0.035, 0.018, 0.7, 0.48, 0.42, 0.15, 50),
        
        # 配置3: 极高仓位 + 极低阈值
        (0.04, 0.02, 0.8, 0.47, 0.43, 0.15, 50),
        
        # 配置4: 大止盈 + 高仓位
        (0.05, 0.025, 0.6, 0.5, 0.4, 0.15, 50),
        
        # 配置5: 大止盈 + 更高仓位
        (0.06, 0.03, 0.7, 0.48, 0.42, 0.15, 50),
        
        # 配置6: 降低调仓阈值（更频繁调仓）
        (0.03, 0.015, 0.6, 0.5, 0.4, 0.1, 50),
        
        # 配置7: 降低最小调仓金额
        (0.03, 0.015, 0.6, 0.5, 0.4, 0.15, 30),
        
        # 配置8: 综合激进1
        (0.04, 0.02, 0.75, 0.48, 0.42, 0.12, 40),
        
        # 配置9: 综合激进2
        (0.045, 0.022, 0.65, 0.49, 0.41, 0.13, 45),
        
        # 配置10: 超激进配置
        (0.05, 0.025, 0.8, 0.47, 0.43, 0.1, 30),
    ]
    ...
    results_df.to_csv('aggressive_optimization_results.csv', index=False)
